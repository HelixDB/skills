...
description: Translate Gremlin and TinkerPop-style traversals into direct HelixDB v3 Rust SDK requests. Use when the input contains Gremlin, TinkerPop, g.V, g.E, hasLabel, has, out, in, both, outE, inE, repeat, emit, dedup, valueMap, count, range, or limit. For Helix Cloud, select MCP tools by session identity and available permissions.
license: MIT
metadata:
  author: HelixDB
  version: 3.0.1
